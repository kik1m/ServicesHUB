...
/**
 * AdminSettingsManager - Elite System Configuration (Next.js Port)
 */
                                        ...
                                        <div className={styles.mediaConfig}>
                                            <div className={styles.previewBox}>
                                                {adminImagePreview || newTool?.image_url ? (
                                                    <SmartImage src={adminImagePreview || newTool?.image_url} alt="Preview" containerClassName={styles.previewImg} />
                                                ) : (
