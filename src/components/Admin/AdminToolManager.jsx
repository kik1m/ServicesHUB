...
/**
 * AdminToolManager - Elite Multi-Tool Orchestrator (Next.js Port)
 */
const AdminToolManager = memo(({ 
    ...
    return (
        <Safeguard error={error} onRetry={onRetry}>
            <div className={`${styles.managerWrapper} fade-in`}>
                                ...
                                <article key={tool.id} className={styles.toolCard}>
                                    ...
                                    <div className={styles.cardInfo}>
                                        ...
                                        <p className={styles.dateInfo}>
                                            Added on {tool?.created_at ? new Date(tool.created_at).toLocaleDateString() : 'Recent'}
                                        </p>
                                    </div>
                                </article>
                            ))}
