                        ...
                        <div className={styles.toolInner}>
                            {toolData?.image_url && (
                                <div className={styles.toolImageWrapper}>
                                    <SmartImage src={toolData.image_url} alt={toolData.name} containerClassName={styles.toolImage} />
                                </div>
                            )}
                            ...
                            <div className={styles.toolActions}>
                                <Link href={`/tool/${toolData?.slug || toolId}`} className={styles.exploreBtn}>
                                    <span>Details</span>
                                    <ArrowRight size={14} />
                                </Link>
                                {toolData?.url && (
                ...
                return (
                    <div key={index} className={styles.compareEmbedCard}>
                        <div className={styles.compareContent}>
                            ...
                            <Link href={`/compare/${slug1}-vs-${slug2}`} className={styles.compareActionBtn}>
            ...
            if (imageMatch) {
                ...
                return (
                    <div key={index} className={styles.inlineImageWrapper}>
                        <SmartImage src={imageUrl} alt={caption || 'Article Image'} containerClassName={styles.inlineImage} />
