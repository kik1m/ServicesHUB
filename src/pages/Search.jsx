...
const Search = () => {
    ...
    useEffect(() => {
        ...
        const timer = setTimeout(fetchTools, 500);
                ...
                <div style={{ display: 'grid', gridTemplateColumns: 'minmax(250px, 300px) 1fr', gap: '3rem' }}>
                                ...
                                <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
                                    {categories.map(cat => (
                                        <button 
                                            ...
                                            style={{ 
                                                display: 'flex', justifyContent: 'space-between', padding: '10px 15px', borderRadius: '10px',
                                                background: selectedCategory === cat.id ? 'rgba(255,255,255,0.05)' : 'transparent',
                                                border: '1px solid', borderColor: selectedCategory === cat.id ? 'var(--primary)' : 'transparent',
                                                color: selectedCategory === cat.id ? 'var(--primary)' : 'var(--text-muted)', textAlign: 'left', cursor: 'pointer'
                                            }}
                                        >
                    ...
                    <main>
                        ...
                        {isLoading ? (
                            ...
                            <div style={{ textAlign: 'center', padding: '5rem', background: 'rgba(255,255,255,0.02)', borderRadius: '30px', border: '1px dashed var(--border)' }}>
